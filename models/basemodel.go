...
// Required just check whether the given string is empty or not
...
// ValidateEmail checks whether the given email is valid or not
...
// MaxSize checks the given string length
